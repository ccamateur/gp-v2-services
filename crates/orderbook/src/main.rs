...
use shared::{
    ...
    price_estimation::{
        baseline::BaselinePriceEstimator, cached::CachingPriceEstimator,
        competition::CompetitionPriceEstimator, instrumented::InstrumentedPriceEstimator,
        paraswap::ParaswapPriceEstimator, quasimodo::QuasimodoPriceEstimator,
        sanitized::SanitizedPriceEstimator, zeroex::ZeroExPriceEstimator, PriceEstimating,
        PriceEstimatorType,
    },
